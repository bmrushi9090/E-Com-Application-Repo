...
const DisplayMobile = () => {
    ...
    const handleDelete = (id) => {
        axios.delete(`http://localhost:9090/auth/deletemobiles/${id}`)
            .then(() => setMobileData(mobileData.filter((data) => data._id !== id)))
    ...
    return (
        <>
            ...
            <div className="f2">
                <Link to="/AddMobile" className="btn add-mobiles"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-plus-circle-fill" viewBox="0 0 16 16">
                    ...
                    {mobileData.map((f) => (
                        <li key={f._id} type='none' className='mr'>
                            <div className="card" style={{ width: '18rem ', height: '450px' }} >
                                {/* style="width: 18rem;" */}
                                <img src={f.img} alt="Error" width={'287px'} height={'270px'} />
                                <div className="card-body">
                                    <br /> <p className="card-data"><svg onClick={() => handleDelete(f._id)} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-trash3-fill wish-delete" viewBox="0 0 16 16">
